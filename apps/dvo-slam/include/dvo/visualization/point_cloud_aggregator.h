...
{
public:
  typedef std::function<dvo::visualization::AsyncPointCloudBuilder::PointCloud::Ptr()> PointCloudBuilderCallable;
...
private:
  std::scoped_ptr<internal::PointCloudAggregatorImpl> impl_;
};
